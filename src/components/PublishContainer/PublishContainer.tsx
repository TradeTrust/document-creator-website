        ...
        <div className="container mx-auto pt-8">
          ...
          <div className="flex justify-between items-end">
            {documentsPublished ? (
              ...
              <Title>Publishing document(s)</Title>
            )}
        ...
        <div className="bg-white-dark p-6 h-screen">
          <div className="container mx-auto">
            {documentsPublished ? (
              ...
              <Wrapper>
                <div className="bg-white container mx-auto p-4 h-auto">
                  <div className="text-grey-dark font-medium text-lg">
                    Publishing {forms.length} Document!
                  </div>
                  <div className="text-grey-dark font-medium text-lg">

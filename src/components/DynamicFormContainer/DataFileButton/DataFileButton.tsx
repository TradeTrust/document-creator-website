...
export const DataFileButton: FunctionComponent<DataFileButton> = ({ onDataFile, schema }) => {
  ...
  return (
    <>
      ...
      <div
        className="py-8 px-20 mb-4 font-light text-center rounded-xl border-dashed border-2 border-cloud-100"
        style={{ backgroundColor: "#FFF7E2" }}
      >
        <div className="flex justify-center">
          <img src={"/static/upload-cloud.png"} />
        </div>
        <p className="my-6">{text.header}</p>
        <div className="mb-4" data-testid="data-upload-zone" {...getRootProps()}>
          ...
          <Button
            ...
            className="bg-white text-cerulean-500 border-gray-300 hover:bg-gray-50"
          >
            {text.buttonText}
          </Button>
        </div>
      </div>
      <div className="flex text-sm justify-between text-cerulean-200 px-4">

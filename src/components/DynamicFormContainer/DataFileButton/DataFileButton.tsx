...
export const DataFileButton: FunctionComponent<DataFileButton> = ({ onDataFile, schema }) => {
  ...
  return (
    <>
      ...
      <div className="p-8 font-light" style={{ backgroundColor: "#FFF7E2" }}>
        ...
        <div className="mb-4" data-testid="data-upload-zone" {...getRootProps()}>
          ...
          <Button
            ...
            className="w-full bg-white text-blue-500 border-gray-300 hover:bg-gray-100"
          >
            {text.buttonText}
          </Button>
        </div>
      </div>
      <div className="flex text-sm justify-between text-cerulean-200">

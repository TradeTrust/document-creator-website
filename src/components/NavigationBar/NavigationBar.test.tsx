...
import configRinkeby from "../../test/fixtures/config/v2/rinkeby/sample-config-rinkeby.json";
import configRopsten from "../../test/fixtures/config/v2/ropsten/sample-config-ropsten.json";

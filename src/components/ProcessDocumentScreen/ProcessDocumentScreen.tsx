          ...
          <div className="container">
            ...
            <div className="bg-red-100 p-3 flex flex-col">
              <div className="flex">
                ...
                <div className="text-red-500 ml-2 flex-grow" data-testid="error-message">
                ...
                <Button className="bg-white text-red-500 hover:bg-gray-100">
                  ...
                  >
                    <div className="flex">
                      <Download />
                      <div className="text-red-500 ml-2">Download Error Log</div>
                    </div>
                  </a>
                </Button>
              </div>
            ...
            <div className="bg-red-100 p-3 flex flex-col">
              <div className="flex">
                ...
                <div className="flex flex-col flex-grow">
                  <div className="text-red-500 ml-2 flex-grow" data-testid="error-title">
                    {`Failed to ${isIssuingFlow ? "publish" : "revoke"} due to:`}
                  </div>
                  <div className="text-red-500 ml-2 flex-grow">- {error?.message}</div>
                  <div className="text-red-500 ml-2 flex-grow">
                    {`Kindly rectify and try ${isIssuingFlow ? "publishing" : "revoking"} again.`}
                  </div>
                </div>
                <Button className="bg-white text-red-500 hover:bg-gray-100 h-12">
                  <a
                    download={generateFileName({
                      network: config?.network,
                      fileName: "error-log",

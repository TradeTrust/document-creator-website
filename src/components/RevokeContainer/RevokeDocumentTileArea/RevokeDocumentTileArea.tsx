...
export const RevokeDocumentTileArea: FunctionComponent<RevokeDocumentTileArea> = ({
  ...
  const revokeButtonColor = isDisabled ? "bg-cloud-500 cursor-not-allowed" : "bg-scarlet-500 hover:bg-red-600";
  return (
    <Wrapper>
      <div className="mb-4">
        ...
        <Card>
          ...
          <div className="flex justify-center mt-16">
            <Button
              ...
              className="w-auto px-8 text-cerulean-500 mb-8 bg-white mr-4 hover:bg-cloud-100"
            >
              Back
            </Button>
            <Button

...
export const dataFileJsonEbl = "./../src/test/fixtures/data-file/sample-data-file-ebl.json";
export const dataFileCsvEbl = "./../src/test/fixtures/data-file/sample-data-file-ebl.csv";
export const dataFileCsvCoo = "./../src/test/fixtures/data-file/sample-data-file-coo.csv";

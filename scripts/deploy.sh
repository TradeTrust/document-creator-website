...
open-attestation deploy document-store "My Document Store" -n local -k $account_key

# Deploy token registry to 0x9Eb613a88534E2939518f4ffBFE65F5969b491FF
open-attestation deploy token-registry "My Token Registry" MTR -n local -k $account_key

# Deploy title escrow creator to 0x4Bf7E4777a8D1b6EdD5F2d9b8582e2817F0B0953
open-attestation deploy title-escrow-creator "test" -n local -k $account_key